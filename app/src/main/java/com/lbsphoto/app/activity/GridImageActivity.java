...
import com.lbsphoto.app.LoadLoacalPhotoCursorTask;
import com.lbsphoto.app.R;
import com.lbsphoto.app.SelectedTreeMap;
import com.lbsphoto.app.adapter.ImageAdapter;
...
public class GridImageActivity extends BaseActivity {
    ...
    private void init() {
        ...
        if (bundle != null) {
			...
			Log.i(GridImageActivity.class.getSimpleName(), "bundle == null");
		}
        ...
        cursorTask.setOnLoadPhotoCursor(new LoadLoacalPhotoCursorTask.OnLoadPhotoCursor() {
            ...
            public void onLoadPhotoSursorResult(ArrayList<Uri> uriArray, ArrayList<Long> origIdArray) {
                if (isNotNull(uriArray) & isNotNull(origIdArray)) {
                    GridImageActivity.this.uriArray = uriArray;
                    GridImageActivity.this.origIdArray = origIdArray;
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (clazz != null) {
                    ...
                    Intent intent = new Intent(GridImageActivity.this, clazz);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable(RESULT_URIS, selectedTreeMap);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else {
					Log.i(GridImageActivity.class.getSimpleName(), "clazz==null");
				}
            }
        });
